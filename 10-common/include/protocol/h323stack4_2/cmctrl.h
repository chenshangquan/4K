 ...
 * ----------------------------------------------------------------------------
 * Arguments:
 * Input:  haChan      - The Application channel handle.
		   hsChan      - The channel handle whose parameter has been requested.
 *         eParam      - The parameter requested. The list of parameters is
 *                       defined in cmCallParam enumeration.
 *         RTAddr      - Transport Address
 *****************************************************************************/
//add by yj for ipv6
typedef int
	(RVCALLCONV *cmEvChannelGetParamT)(
...
typedef int
    (RVCALLCONV *cmEvCallCapabilitiesExtT)(
        ...
        IN      HCALL               hsCall,
        IN      cmCapStruct***      capabilities[],
		IN      int                 multiplexCapabilityNode);
#else
typedef int
    (RVCALLCONV *cmEvCallCapabilitiesExtT)(
        IN      HAPPCALL            haCall,
