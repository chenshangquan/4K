...
const int    AID_MT_MPREMOTEMGR	=	 AID_MT_BEGIN + 41;    	     //远程MP管理 
//End
...
const u32 TP_VIDEO_PRIOM_DEFAULT_CHANBITRATE = 4096;
const u32 TP_VIDEO_DUAL_DEFAULT_CHANBITRATE = 4096;
...
#define TP_ETHNET1_IP_DEFAULT         "0.0.0.0"       // edited by heweihang 默认值为0，tptools上显示为空白 原为192.169.0.2
