...
enum enNetraID
{
	...
	ID_NETRA4,									//双流屏
	NETRA_NUM,									//netra 个数
	ID_NETRA_INVALID = NETRA_NUM
};

//T300 每片netra编解码器最大创建个数
#define  MAX_DEC_CHANNEL_NUM (1)				//单片只创建1个解码器
#define  MAX_ENC_CHANNEL_NUM (2)				//单片创建2个编码器(合成器编码器复用已创建的第一路编码器)
...
enum enVideoPIPIndex
{
	...
	VIDEO_PIPINDEX_ADD_T300,              //本地双流采集
    VIDEO_PIPINDEX_INVALID
};

enum enMeetingRoomType
{
	MR_Close = 0,
	MR_1080P,
	MR_720P,
...
//////////////////////////////////////////////////////////////////////////
//画面合成风格(与平台的声明保持一致)，T300只用4风格一种
enum enVideoMergeStyle
{
	MERGE_BASE = 100,
	MERGE_M1 = 100,															//
	MERGE_M3 = 300,															//
...
#define MAX_MERGE_CHN_NUM  (MERGE_INVALID/MERGE_BASE)						//最大合成通道数，主画面作为底图
#define PIPINDEX_TO_MERGECHN(x, y) (x*((u32)VIDEO_PIPINDEX_INVALID) + y)	//多片netra画中画位置索引
#define MERGECHN_TO_NETRAID(x) (x/((u32)VIDEO_PIPINDEX_INVALID))			//多片netra画中画位置索引，netra id
#define MERGECHN_TO_PIPINDEX(x) (x%((u32)VIDEO_PIPINDEX_INVALID))			//多片netra画中画位置索引，PIP index，参见enVideoPIPIndex
//合成编码参数
typedef struct tagMergeChn
{
	enVideoMergeStyle m_wMergeStyle;										//合成类型，当前只有1种4画面
	u32 m_adwChannelList[MAX_MERGE_CHN_NUM];								//合成通道列表，按最大合成风格时的通道数创建
	u32 GetMergeChannelNum(){return (u32)(m_wMergeStyle / MERGE_BASE);};
}TMergeChn;
//////////////////////////////////////////////////////////////////////////
...
#define AUDIO_C0_LEFT     0x00000001//RCA0端左声道
#define AUDIO_C0_RIGHT	  0x00000002//RCA0端右声道
...
#define AUDIO_MIC0        0x00000080//卡农0
#define AUDIO_MIC1        0x00000100//卡农1
#define AUDIO_MIC2        0x00000200//卡农2
#define AUDIO_MIC3        0x00000400//卡农3
#define AUDIO_MIC4        0x00000800//卡农4
#define AUDIO_MIC5        0x00001000//卡农5
#define AUDIO_MIC6        0x00002000//卡农6
#define AUDIO_MIC7        0x00004000//卡农7
#define AUDIO_MIC8        0x00008000//卡农8
#define AUDIO_MIC9        0x00010000//卡农9
#define AUDIO_DIGIT0      0x00020000//数字麦克0
#define AUDIO_DIGIT1      0x00040000//数字麦克1
#define AUDIO_DIGIT2      0x00080000//数字麦克2
...
#define AUDIO_HDMI1       0x02000000//DVI-HDMI1 对应板卡上的AUX1
#define AUDIO_HDMI2       0x04000000//DVI-HDMI2 对应板卡上的AUX2
#define AUDIO_HDMI3       0x08000000//DVI-HDMI3 对应板卡上的AUX3
#define AUDIO_HDMI4       0x10000000//DVI-HDMI4 对应板卡上的AUX4
#define AUDIO_HDMI5       0x20000000//DVI-HDMI5 对应板卡上的AUX5
#define AUDIO_HDMI6       0x40000000//DVI-HDMI6 对应板卡上的AUX6
#define AUDIO_SPEAKER     0x80000000//扬声器
