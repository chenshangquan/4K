...
unsigned char *stream_get_data (struct stream *);
...
int stream_puts (struct stream *, char*);
...
void stream_gets (struct stream*, char*);
...
u_int32_t stream_getl_from(struct stream *, unsigned long);
