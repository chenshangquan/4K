...
enum enMulPicType
{
    ...
    //以下为网呈VMP_SIMPLE模式风格
    MULPIC_TYPE_SIMPLE_ONE,    //一画面风格，无小画面
    MULPIC_TYPE_SIMPLE_TWO,    //一大一小两画面
    MULPIC_TYPE_SIMPLE_THREE,  //一大两小三画面
    MULPIC_TYPE_SIMPLE_FOUR,   //一大三小四画面
    MULPIC_TYPE_SIMPLE_FIVE,   //一大四小五画面
    MULPIC_TYPE_SIMPLE_SIX,    //一大五小六画面
    MULPIC_TYPE_SIMPLE_SEVEN,  //一大六小七画面
    MULPIC_TYPE_SIMPLE_EIGHT,  //一大七小八画面
    MULPIC_TYPE_SIMPLE_NINE,   //一大八小九画面
    MULPIC_TYPE_SIMPLE_TEN,    //一大九小十画面
