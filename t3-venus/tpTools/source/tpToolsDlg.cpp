...
BOOL CTpToolsDlg::InitControl()
{
	...
	m_stCoryRight.SetWindowPos( NULL, rectClient.Width()/2-m_stCoryRight.GetImageSize().cx-145,  rectClient.bottom - 29, m_stCoryRight.GetImageSize().cx, m_stCoryRight.GetImageSize().cy, SWP_SHOWWINDOW );
	
	CString strVersion = "            2012-2019 苏州科达科技股份有限公司 Tptools-JD-V";
