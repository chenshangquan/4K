...
public:
	...
	* @remarks 
	*/	
	virtual u16 SetMoon904KCamCfgCmd( const EmCamCfgType& emCamCfgType, const u32& dwValue ) = 0;
	...
	* @remarks 
	*/	
	virtual u8 GetMoon90CamExpGain() = 0;
	...
	* @remarks 
	*/	
    virtual u16 GetMoon90CamExCompRate() = 0;
	...
	* @remarks 
	*/	
    virtual u8 GetMoon90CamBLCRate() = 0;
    ...
    * @remarks 
    */	
    virtual u8 GetMoon90CamWDRRate() = 0;
};
#endif
